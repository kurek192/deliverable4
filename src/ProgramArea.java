...
/**
 * The actual input program, converted from a big String to an m * n array of
 * chars.
 */
public class ProgramArea {
    ...
    /**
     * Fills up the program area with spaces (the "ignore" opcode) before
    ...
    /**
     * Default constructor. Creates a ProgramArea which is all spaces
     */
    public ProgramArea() {
        fillUpSpaces();
    }
    ...
    /**
     * Get the opcode from a particular place in the program area. If opcode is
     * not in program space, return null char (ASCII 0).
     *
    ...
    /**
     * Set the opcode at a particular place in the program area. If out of
     * bounds, do nothing.
     *
     * @param x x-coordinate
     * @param y y-coordinate
